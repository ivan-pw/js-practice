...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.carousel = function () {
  for (let i = 0; i < this.length; i++) {
    const {
      width
    } = window.getComputedStyle(this[i].querySelector('.carousel-inner'));
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeToggle = function (dur, display, fin) {
  for (let i = 0; i < this.length; i++) {
    console.log((0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]));
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.wrap').html(`
  ...
  `);
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.dropdown-toggle-js').dropdown();
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => {
  (0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
    ...
    btns: {
      count: 3,
      settings: [['Close', ['btn-danger', 'mr-10'], true], ['another btn', ['btn-warning', 'mr-10'], false, () => {
        alert('oh my gosh');
